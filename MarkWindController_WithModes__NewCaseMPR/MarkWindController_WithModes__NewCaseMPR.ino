...
//  Serial.println(instrumentMode);
  ...
  switch (instrumentMode){
    case 0:
      fingeredNote=startNote + (2*LH + LH2 + 3*LH3 + 7*LH4) - (2*RH1 + RH2 + 3*RH3 + 7*RH4 + 2*RH5 + LH6) + (7*TH1 + 5*TH2) - (5*TH3 + 7*TH4) + (12*OCTup) - (12*OCTdn) + (octave*12) + transposition; // Tuba mode
      break;
    case 1:
