...
void readSwitches(){  
 ...
 // RHp3=touchRead(0)>touch_Thr;
  ...
  //fingeredNote=startNote-2*LH1-LH2-(LH2 && LH1)-2*LH3+LH4-RH1-(RH1 && LH3)-RH2-2*RH3-RH4+(RH4)+12*OCTup-12*OCTdn+9*(!LH1 && LH2 && LH3);
  fingeredNote=startNote - (2*LH1) - (LH2) - 4*LH3 - (7*LH4) + ((2*RH1) + (RH2) + 4*RH3 + (7*RH4)) + (12*OCTup) - (12*OCTdn) + (octave*12) + transposition; // Option 1
  //fingeredNote=startNote - (2*LH1) - (4*LH2) - LH3 - (7*LH4) + ((2*RH1) + (4*RH2) + RH3 + (7*RH4)) + (12*OCTup) - (12*OCTdn); // Option 2
