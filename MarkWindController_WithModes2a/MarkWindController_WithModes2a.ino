...
//void pitch_bend(){
//  pitchBend = analogRead(A0) *2; // read voltage on analog pin A0
//  //Serial.println(pitchBend);
//  if (pitchBend > modsHi_Thr){
...
//  } else {
//    pitchBend = oldpb*0.6+8192*0.4; // released, so smooth your way back to zero
//    if ((pitchBend > 8180) && (pitchBend < 9010)) pitchBend = 8192; // 8192 is 0 pitch bend, don't miss it bc of smoothing
//  }
//  if (mod || (ccList[breathCC]==1)){
////    if (PB) pitchBend += lfoLevel/6; else pitchBend += lfoLevel;
