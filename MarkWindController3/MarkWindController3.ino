...
void setup() {
  ...
  pinMode(2,INPUT_PULLUP); // Midi Channel +
  pinMode(3,INPUT_PULLUP); // Midi channel -
  pinMode(4,INPUT_PULLUP); // octave up
  pinMode(5,INPUT_PULLUP); // octave down
  pinMode(7,INPUT_PULLUP); // transpose +
  pinMode(8,INPUT_PULLUP); // transpose -
...
void mainLoop() {  
  ...
  while(1){
          // read Mark's control buttons
   int octUpButton = digitalRead(4);
   int octDownButton = digitalRead(5);
   int transUpButton = digitalRead(7);
   int transDownButton = digitalRead(8);
   //digitalRead(2);  //midi chan + 
    //digitalRead(3);  // midi chan -
...
//      Serial.println(octave);
    ...
    if (octDownButton == LOW){
      octave --;  // octave down
//      Serial.println(transposition);
//      Serial.println(octave);
    }
    if (transUpButton == LOW){
      transposition ++;  // transpose up half step
//      Serial.println(transposition);
//      Serial.println(octave);
    }
    if (transDownButton == LOW){
