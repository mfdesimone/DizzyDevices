...
#define BREATHCURVE_FACTORY 12     // 0 to 12 (-4 to +4, S1 to S4)
...
void setup() {
  ...
  pinMode(ExtraPin,INPUT_PULLUP); // Extra Button
  ...
  ExtraPinDebo.attach(ExtraPin);
  ExtraPinDebo.interval(debounceInterval); // interval in ms
...
//      fingeredNoteL=constrain(startNote - ((2*LH1) + (LH2) + 4*LH3 + (5*LH4)) - (5*TH1 + 7*TH2) + (7*TH3 + 5*TH4)  + (12*OCTup) - (12*OCTdn) + (octave*12) // Left hand
    ...
    case 4:
      ...
      break;
    case 5:
      fingeredNote=constrain(startNote - ((2*RH1) + (RH2) + 4*RH3 + (7*RH4) + 2*RH5 + RH6) - (5*TH1 + 7*TH2) + (7*TH3 + 5*TH4) + (12*OCTup) - (12*OCTdn) + (octave*12) // Right hand
      ,0, 127);
      fingeredNoteL=constrain(fingeredNote + ((2*LH1) + (LH2) + 4*LH3 + (7*LH4)) // Left hand
      ,0, 127);
      break;
    case 6: // B flat drone
      fingeredNote=constrain(fingeredNote=startNote + (2*LH1) + (LH2) + 4*LH3 + (7*LH4) - ((2*RH1) + (RH2) + 3*RH3 + (5*RH4) + 2*RH5 + RH6) - (5*TH1 + 7*TH2) + (7*TH3 + 5*TH4) + (12*OCTup) - (12*OCTdn) + (octave*12) // Both hands
      ,0, 127);
