...
//  Serial.println(instrumentMode);
  ...
  switch (instrumentMode){
    case 0:
      fingeredNote=constrain(startNote + (2*LH1 + LH2 + 4*LH3 + 7*LH4) - (2*RH1 + RH2 + 3*RH3 + 5*RH4 + 2*RH5 + RH6) - (5*TH1 + 7*TH2) + (7*TH3 + 5*TH4) + (12*OCTup) - (12*OCTdn) + (octave*12) + transposition // Tuba mode
      ,0, 127);
      break;
    case 1:
      fingeredNote=constrain(startNote - (2*LH1) - (LH2) - 4*LH3 - (7*LH4) + ((2*RH1) + (RH2) + 4*RH3 + (7*RH4) + 2*RH5 + RH6) - (7*TH1 + 5*TH2) + (7*TH1 + 5*TH2) - (5*TH3 + 7*TH4)  - (5*TH3 + 7*TH4) + (12*OCTup) - (12*OCTdn) + (octave*12) + transposition // LH  is descending intervals, RH is ascending intervals
      ,0, 127); break;
    case 2:
